...
declare module '$env/static/private' {
	...
	export const VITE_ANALYTICS_ENABLED: string;
	export const VITE_CLIPBOARD_ENABLED: string;
	export const VITE_DRAG_DROP_ENABLED: string;
	export const VITE_PREVIEW_ENABLED: string;
	export const VITE_MAX_FILE_SIZE: string;
	export const VITE_PROCESSING_TIMEOUT: string;
	...
	export const EFC_10100_1592913036: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		VITE_CLIPBOARD_ENABLED: string;
		VITE_DRAG_DROP_ENABLED: string;
		VITE_PREVIEW_ENABLED: string;
		VITE_MAX_FILE_SIZE: string;
		VITE_PROCESSING_TIMEOUT: string;
		ACLOCAL_PATH: string;
